...
from einstein.layers.recurrent import LSTM, StackableGRU, StackableSGU, SGUModified1, SimpleGatedUnit
...
records_file = E.fileio.FileIO("sgumodified1.txt")
for i in xrange(50):
    print('Build model...')
    model = Sequential()
    model.add(Embedding(max_features, 256))
    model.add(SGUModified1(256, 128))
