...
for run_time in xrange(run_times):
    ...
    record_file = FileIO()
    record_file.save_pickle(record_times, "single_sgu_%d_adam_sigmoid_titan_losses"%run_time )
    record_file.save_pickle(record_losses, "single_sgu_%d_adam_sigmoid_titan_times"%run_time )
