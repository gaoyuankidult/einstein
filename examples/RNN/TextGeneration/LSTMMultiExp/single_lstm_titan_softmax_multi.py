...
for run_time in xrange(run_times):
    ...
    record_file = FileIO()
    record_file.save_pickle(record_times, "single_lstm_%d_adam_softmax_titan_losses"%run_time )
    record_file.save_pickle(record_losses, "single_lstm_%d_adam_softmax_titan_times"%run_time )
