"""
This file contains uses clockwork GRU without dropout and it only uses one layer
"""
...
print('Build model...')
model = Sequential()
model.add(ClockworkGRU(periods=[1,2, 4, 8, 16, 32, 64, 128], input_dim=len(chars), output_dim=512, return_sequences=False))
