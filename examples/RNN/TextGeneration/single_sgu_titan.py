...
record_file = FileIO()
record_file.save_pickle(history.val_losses, "single_sgu_adam_sigmoid_titan_losses" )
record_file.save_pickle(history.times, "single_sgu_adam_sigmoid_titan_times" )
