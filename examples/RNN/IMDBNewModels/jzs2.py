...
from keras.layers.recurrent import LSTM, GRU, JZS2
...
model.add(JZS2(256, 128)) # try using a GRU instead, for fun
...
record_file = FileIO()
record_file.save_pickle(history.losses, "jsz2_record_titan_x")
