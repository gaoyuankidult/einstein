...
record_file = FileIO()
record_file.save_pickle(history.losses, "gru_record_titan_x_losses")
record_file.save_pickle(history.times, "gru_record_titan_x_times")