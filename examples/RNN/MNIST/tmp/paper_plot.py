...
plt.figure(1)
plt.plot(xrange(len(dsgu_losses)), dsgu_losses,'->',
         xrange(len(irnn_losses)), irnn_losses, '-^',
         xrange(len(sgu_losses)), sgu_losses, '-<',
         xrange(len(lstm_losses)), lstm_losses, '-o')
plt.ylabel("Accuracy")
...
plt.figure(2)
plt.plot(dsgu_times, dsgu_losses,'->',
         irnn_times, irnn_losses, '-^',
         sgu_times, sgu_losses, '-<',
         lstm_times, lstm_losses, '-o')
plt.ylabel("Accuracy")
plt.xlabel("Seconds")
