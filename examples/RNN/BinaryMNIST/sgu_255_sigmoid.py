...
record_file = FileIO()
record_file.save_pickle(history.losses, "%s_255_sigmoid_titan_x_losses" % ClassModel.__class__.__name__.lower())
record_file.save_pickle(history.times, "%s_255_sigmoid_titan_x_times" % ClassModel.__class__.__name__.lower())
