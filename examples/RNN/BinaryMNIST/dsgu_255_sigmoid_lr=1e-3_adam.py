...
record_file = FileIO()
record_file.save_pickle(history.val_losses, "dsgu_adam_%s_255_sigmoid_lr=1e-3_titan_x_losses" % ClassModel.__class__.__name__.lower())
record_file.save_pickle(history.times, "dsgu_adam_%s_255_sigmoid_lr=1e-3_titan_x_times" % ClassModel.__class__.__name__.lower())
