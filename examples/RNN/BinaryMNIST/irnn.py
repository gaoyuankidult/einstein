...
X_train_binary = X_train[get_two_classes(y_train, 0, 1)]
y_train_binary = y_train[get_two_classes(y_train, 0, 1)]
...
record_file = FileIO()
record_file.save_pickle(history.losses, "irnn_record_titan_x_losses")
record_file.save_pickle(history.times, "irnn_record_titan_x_times")