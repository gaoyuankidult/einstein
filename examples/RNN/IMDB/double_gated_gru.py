...
from einstein.layers import DoubleGatedDeepGRU
...
model.add(DoubleGatedDeepGRU(256, 128)) # try using a GRU instead, for fun
...
print("Train...")
model.fit(X_train, y_train, batch_size=batch_size, nb_epoch=6, validation_split=0.1, show_accuracy=True)
