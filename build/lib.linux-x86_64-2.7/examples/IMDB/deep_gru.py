...
from einstein.layers import SimpleDeepGRU, GRU
...
records_file = E.fileio.FileIO("deep_gru_record.txt")
for i in xrange(50):
    print('Build model...')
    model = Sequential()
    model.add(Embedding(max_features, 256))
    model.add(SimpleDeepGRU(256, 128)) # try using a GRU instead, for fun
