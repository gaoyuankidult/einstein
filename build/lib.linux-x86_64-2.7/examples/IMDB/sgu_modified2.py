...
from einstein.layers.recurrent import LSTM, StackableGRU, StackableSGU, SGUModified1, DSGU, SGU
...
records_file = E.fileio.FileIO("sgumodified2.txt")
for i in xrange(50):
    print('Build model...')
    model = Sequential()
    model.add(Embedding(max_features, 256))
    model.add(DSGU(256, 128))
