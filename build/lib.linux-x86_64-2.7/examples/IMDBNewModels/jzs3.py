...
from keras.layers.recurrent import LSTM, GRU, JZS3
...
model.add(JZS3(256, 128)) # try using a GRU instead, for fun
...
record_file = FileIO()
record_file.save_pickle(history.losses, "jzs3_record_titan_x")
